...
function display_footer_categories() {
    ...
    if ($categories) {
        echo '<div class="footer-categories">';
        echo '<h3 style="color: white">Danh Mục</h3>';
        echo '<ul>';
...
// bai viet
function display_footer_recent_posts() {
    global $wpdb;

    $recent_posts = $wpdb->get_results("SELECT * FROM $wpdb->posts 
    ...
    if ($recent_posts) {
        ...
        echo '<h3 style="color: white">Bài Viết Mới Nhất</h3>';
        echo '<ul>';
